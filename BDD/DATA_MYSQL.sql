...
-- 正在导出表  pts3.cocktail 的数据：~5 rows (大约)
...
-- 正在导出表  pts3.compte 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `compte` DISABLE KEYS */;
/*!40000 ALTER TABLE `compte` ENABLE KEYS */;

-- 正在导出表  pts3.contenir 的数据：~0 rows (大约)
