DROP DATABASE IF EXISTS `remy-dut_pts3`;

CREATE DATABASE `remy-dut_pts3`;

USE `remy-dut_pts3`;

ALTER DATABASE `remy-dut_pts3` CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE
	COMPTE
ADD
	CONSTRAINT COMPTE_IDMEMBRE FOREIGN KEY (IDMEMBRE) REFERENCES MEMBRE (ID);
...
CREATE TABLE COCKTAIL (
	...
	DESCRIPTION TEXT,
	FORCEALC INT(2),
	CONSTRAINT CHK_CATEGORIE CHECK (
		CATEGORIE = 'A'
		OR CATEGORIE = 'D'
		OR CATEGORIE = 'AD'
	)
...
CREATE TABLE CONTENIR (
	IDCONTENIR INT(4) PRIMARY KEY AUTO_INCREMENT,
	IDCOCKTAIL INT(4),
	IDINGREDIENT INT(4),
...
CREATE TABLE NOTER (
	IDNOTER INT(4) PRIMARY KEY AUTO_INCREMENT,
	IDMEMBRE INT(4),
	IDCOCKTAIL INT(4),
	NOTE INT(2) NOT NULL,
	CONSTRAINT NOTER_IDCOCKTAIL FOREIGN KEY (IDCOCKTAIL) REFERENCES COCKTAIL (ID),
	CONSTRAINT NOTER_IDMEMBRE FOREIGN KEY (IDMEMBRE) REFERENCES user_member (id),
...
CREATE TABLE STOCKER (
	IDSTOCKER INT(4) PRIMARY KEY AUTO_INCREMENT,
	IDINGREDIENT INT(4),
	IDMEMBRE INT(4),
	ENRESERVE TINYINT(1) NOT NULL,
	CONSTRAINT STOCKER_IDINGREDIENT FOREIGN KEY (IDINGREDIENT) REFERENCES INGREDIENT (ID),
	CONSTRAINT STOCKER_IDMEMBRE FOREIGN KEY (IDMEMBRE) REFERENCES user_member (id)
);

CREATE TABLE PREFERENCE (
	IDPREFERENCE INT(4) PRIMARY KEY AUTO_INCREMENT,
	IDINGREDIENT INT(4),
	IDMEMBRE INT(4),
	CONSTRAINT PREFERENCE_IDINGREDIENT FOREIGN KEY (IDINGREDIENT) REFERENCES INGREDIENT (ID),
	CONSTRAINT PREFERENCE_IDMEMBRE FOREIGN KEY (IDMEMBRE) REFERENCES user_member (id)
);

CREATE TABLE PROPOSE (
	IDPROPOSE INT(4) PRIMARY KEY AUTO_INCREMENT,
	IDCOCKTAIL INT(4),
	IDMEMBRE INT(4),
