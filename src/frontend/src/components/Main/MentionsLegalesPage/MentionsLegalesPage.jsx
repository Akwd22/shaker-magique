    ...
    <div className="page mentions-legales">
      <div className="mentions-legales-container">
        ...
        <p>
          ...
          du site <a href="http://flotof.fr/">flotof.fr</a> l'identité des
          différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Mendes Florence – – Arc sur Tille
          <br />
          <strong>Créateur</strong> : <a href="http://flotof.fr/">Eddy DRUET</a>
          <br />
          <strong>Responsable publication</strong> : Florence MENDES –
          florence.mendes@gmail.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Eddy Druet – adresse.anonyme@xyz.com
          <br />
          <strong>Hébergeur</strong> : Florence Mendes – Arc sur Tille
          <br />
          Crédits : Rémy AULOY, Jocelyn BRIDON, Loic BOICHUT, Ci TANG, Théo
          DONDARINI
          <br />
        </p>
        ...
        <p>
          L’utilisation du site <a href="http://flotof.fr/">flotof.fr</a>{" "}
          ...
          utilisateurs du site <a href="http://flotof.fr/">flotof.fr</a> sont
        ...
        <p>
          ...
          décidée par Mendes Florence, qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
        </p>
        <p>
          Le site <a href="http://flotof.fr/">flotof.fr</a> est mis à jour
          régulièrement par Florence MENDES. De la même façon, les mentions
        ...
        <p>
          Le site <a href="http://flotof.fr/">flotof.fr</a> a pour objet de
          fournir une information concernant l’ensemble des activités de la
          société.
        </p>
        <p>
          Mendes Florence s’efforce de fournir sur le site{" "}
          <a href="http://flotof.fr/">flotof.fr</a> des informations aussi
        ...
        <p>
          ...
          <a href="http://flotof.fr/">flotof.fr</a> sont données à titre
          indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site{" "}
          <a href="http://flotof.fr/">flotof.fr</a> ne sont pas exhaustifs. Ils
        ...
        <p>
          Mendes Florence est propriétaire des droits de propriété
        ...
        <p>
          Mendes Florence ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site flotof.fr, et résultant soit de l’utilisation d’un matériel ne
          répondant pas aux spécifications indiquées au point 4, soit de
          l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          Mendes Florence ne pourra également être tenue responsable des
          dommages indirects (tels par exemple qu’une perte de marché ou perte
          d’une chance) consécutifs à l’utilisation du site{" "}
          <a href="http://flotof.fr/">flotof.fr</a>.
        </p>
        <p>
          Des espaces interactifs (possibilité de poser des questions dans
          l’espace contact) sont à la disposition des utilisateurs. Mendes
          Florence se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, Mendes Florence
        ...
        <p>
          ...
          <a href="http://flotof.fr/">flotof.fr</a> n'est publiée à l'insu de
          l'utilisateur, échangée, transférée, cédée ou vendue sur un support
          quelconque à des tiers. Seule l'hypothèse du rachat de Mendes Florence
        ...
        <p>
          Le site <a href="http://flotof.fr/">flotof.fr</a> contient un certain
          nombre de liens hypertextes vers d’autres sites, mis en place avec
          l’autorisation de Mendes Florence. Cependant, Mendes Florence n’a pas
        ...
        <p>
          La navigation sur le site <a href="http://flotof.fr/">flotof.fr</a>{" "}
        ...
        <p>
          ...
          <a href="http://flotof.fr/">flotof.fr</a> est soumis au droit
