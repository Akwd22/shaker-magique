...
urlpatterns = [
    ...
    path('notes/<int:idcocktail>/', NoterAvgCocktail.as_view(), name='notes-avg-cocktail'),
    path('notes/<int:idmembre>/<int:idcocktail>/', NoterUserDetail.as_view(), name='notes-user-detail'),
